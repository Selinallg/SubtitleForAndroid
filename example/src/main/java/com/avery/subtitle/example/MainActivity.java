...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String VIDEO_URL = "/sdcard/3D/subtitle/3D-10min.mp4";
    private static final String SUBTITLE_URL = "/sdcard/3D/subtitle/track4_chi.srt";
    ...
    private void initPlayer() {
        ...
        File subtitle_file = new File(SUBTITLE_URL);
        if (subtitle_file.exists()){
            Log.d(TAG, "initPlayer: sucess 字幕文件OK");
        }else {
            Log.d(TAG, "initPlayer: fail 字幕文件不存在");
        }
